...
🤖  **Могу содать Telegram-ботов** для автоматизации задач, например генерации тестовых платёжных данных для проверки сценариев оплаты.

🎨 **Дополнительные компетенции:** имею опыт в графическом и UI/UX-дизайне. Это помогает смотреть на продукт шире: я проверяю не только «работает/не работает», но и удобно ли пользователю, логично ли устроен интерфейс, не возникают ли визуальные противоречия. Такой подход позволяет замечать то, что часто упускают при функциональном тестировании.

🎯  **Мне важно видеть результат своей работы,** поэтому я всегда стараюсь понять, для кого мы делаем продукт и как люди будут им пользоваться. Когда понимаешь пользователя, тестирование перестаёт быть просто поиском ошибок, а превращается в заботу о том, каким продукт достанется людям.

🤝 **Открыта к предложениям,** мне важно найти команду, где поддержат на старте и дадут возможность расти. Готова проходить тестовые и вникать в продукты.

### Если в вашей компании есть **подходящая вакансия**, буду рада обсудить детали  
- <img height="20" width="20" src="https://github.com/belyakovko/belyakovko/blob/259dfb7451faa9d0b906502b658f67e51f61f9dd/assets/icon_mail.png"/> [densv230@gmail.com](mailto:densv230@gmail.com)
- <img height="20" width="20" src="https://github.com/belyakovko/belyakovko/blob/259dfb7451faa9d0b906502b658f67e51f61f9dd/assets/icon_telegram.png"/> [@vetadnsv](https://t.me/vetadnsv)
...
### Джуны. Hr-сервис [hiiire](https://hiiire.com/)
<table class="table" border="0" width="100%">
    <td align="center"><img width="300" src="https://github.com/Shr-Sveta-QA/Shr-Sveta-QA/blob/main/assets/svetlana_denisova-hiiire.png" />  
    <td align="left">
      <b>О проекте:</b><br>
      - Hr-сервис hiiire — сайт для AI-подбора персонала<br>
      - Тестирование функционала приложения на основе документации, чек-листов и доп. сценариев<br>
      - Состав команды: QA-тимлид, тест-менеджер и 7 тестировщиков<br>
      - Длительность стажировки: 56 часов<br>
      - Результат работы передали тестировщикам из команды Hr-сервис hiiire<br>
      <br>
      <b>Моя зона ответственности:</b><br>
      - Провела исследовательское тестирование функционала веб-приложения<br>
      - Изучила и проанализировала проектную документацию<br>
      - Тестировала продукт на основе чек-листов и дополнительных сценариев<br>
      - Оформила 17 баг-репортов в таск-трекере Buildin<br>
      - Провела ревью баг-репортов других участников команды<br>
      - Участвовала в ежедневных синках (daily meetings) с командой<br>
      <br>
      <b>Стек:</b> Buildin <br>
    <a href="https://miro.com/app/board/uXjVGpfBMlQ=/?share_link_id=848584175483">[Отчёт о тестировании]</a> <br>

</table>

### Джуны. Школа дизайна [НИУ ВШЭ](https://hsedesign.ru)
<table class="table" border="0" width="100%">
    <td align="center"><img width="300" src="https://github.com/Shr-Sveta-QA/Shr-Sveta-QA/blob/main/assets/26_adminka.png" />   \n
    <td align="left">
      <b>О проекте:</b><br>
      - Административная панель сайта Школы дизайна НИУ ВШЭ — инструмент для управления контентом<br>
      - Работа с технической документацией и дизайн-макетами в Figma<br>
      - Состав команды: QA-тимлид, 7 стажеров<br>
      - Длительность стажировки: 56 часов<br>
      - Результат работы передан команде разработки<br>
      <br>
      <b>Моя зона ответственности:</b><br>
      - Провела функциональное и UI-тестирование с использованием чек-листов<br>
      - Изучила и проанализировала документацию и макеты в Figma<br>
      - Составляла чек-листы<br>
      - Оформила 10 баг-репортов в Buildin<br>
      - Провела ревью баг-репортов других участников<br>
      - Участвовала в ежедневных синках с командой<br>
      <b>Стек:</b> DevTools, Figma, Buildin<br>
     <a href="https://miro.com/app/board/uXjVGpKVMx0=/?share_link_id=40472530181">[Отчёт о тестировании]</a> <br>
</table>
...
<table class="table" border="0" width="100%">
  <tr align="center">
    <td><img width="300" src="https://github.com/Shr-Sveta-QA/Shr-Sveta-QA/blob/main/assets/003f02c48ad.png" /></td>
    <td><img width="300" src="https://github.com/Shr-Sveta-QA/Shr-Sveta-QA/blob/main/assets/Denisova_Svetlana.jpg" ></td>
  </tr>
</table>
<!--
