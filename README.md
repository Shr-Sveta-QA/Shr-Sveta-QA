...
🎯  **Для меня важно,** чтобы моя работа влияла на результат. Поэтому моя цель — не просто сидеть в задачах, а понимать, как продукт живёт, кто им пользуется и как сделать его лучше.
