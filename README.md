...
📝 **В баг-репортах ценю чёткость.** Описываю так, чтобы разработчик открыл, кивнул и пошёл чинить, без уточнений в лс.

🛠️ **Инструменты:** Postman, DevTools, Charles, SQL, немного Python + Cypress в перспективе для автоматизации рутины.
