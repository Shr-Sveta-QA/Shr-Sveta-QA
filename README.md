...
<table class="table" border="0" width="100%">
  ...
  <br>
  <b>Ключевые результаты:</b><br>
  - Провела более 150 тестов за время стажировки<br>
  - Выявила 20 багов, оформила 17 баг-репортов, 3 намеренно передала другим тестировщикам (для распределения нагрузки и практики новых участников)<br>
  - Добавила 3 рекомендации по улучшению сервиса (не только баги, но и предложения по UX/функциональности)<br>
  - Прошла полный цикл взаимодействия с командой: от изучения документации до ревью чужих отчётов<br>
  - Итоги работы переданы команде тестировщиков hiiire для дальнейшей работы над продуктом<br>
  - Стек: Buildin
</td>
